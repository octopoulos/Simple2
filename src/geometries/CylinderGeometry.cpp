...
{
	std::string args = FormatStr("%s %s %s %d %d %d %s %s", Cfloat(radiusTop), Cfloat(radiusBottom), Cfloat(height), radialSegments, heightSegments, openEnded, Cfloat(thetaStart), Cfloat(thetaLength));
