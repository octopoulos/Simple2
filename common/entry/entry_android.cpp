...
struct Context
{
	...
	void run(android_app* _app)
	{
		...
		ANativeActivity_setWindowFlags(m_app->activity, 0 | AWINDOW_FLAG_FULLSCREEN | AWINDOW_FLAG_KEEP_SCREEN_ON, 0);
...
int32_t MainThreadEntry::threadFunc(bx::Thread* _thread, void* _userData)
{
	...
	BX_ASSERT(0 == result, "Failed to chdir to directory (errno: %d, android.permission.WRITE_EXTERNAL_STORAGE?).", errno);
